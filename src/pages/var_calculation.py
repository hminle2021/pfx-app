...
import numpy as np
import pandas as pd
from .var_utils import (sumproduct, get_daily_historical_var_df, get_W_SD_info, 
...
def render() -> None:
    ...
    ### Read Data
    bid_change_path = Path("data/bid_change_updated_08_2021.csv")
    w_sd_path = Path("data/SD_Portfolio_2_pairs_2021_updated_08_2021.csv")
